...
// // 4 notes spread across 0.04 → 0.96
// // Each note gets 0.92 / 4 = 0.23 of the scroll
// // Gap between notes is baked into the fadeOut → next fadeIn distance
// const TIMINGS = [
//   { fadeIn: 0.04, peak: 0.10, fadeOut: 0.18, end: 0.24 },
//   { fadeIn: 0.30, peak: 0.36, fadeOut: 0.44, end: 0.50 },
//   { fadeIn: 0.56, peak: 0.62, fadeOut: 0.70, end: 0.76 },
//   { fadeIn: 0.82, peak: 0.88, fadeOut: 0.92, end: 0.96 },
// ];
